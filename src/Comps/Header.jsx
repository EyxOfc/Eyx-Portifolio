...
function Header() {
    return ( 
        <>
        <header className='fixed top-0 left-0 flex flex-row flex-nowrap items-center justify-between gap-[10px] transition .3s w-full h-[60px] px-[10px] bg-white/25 dark:bg-white/10 shadow-md hover:shadow-lg backdrop-blur-[5px]'>
